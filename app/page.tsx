...
const foundersByLanguage: Record<Language,Founder[]> = {
  ko:[
    ...
    {role:"COO",name:"오병국",alternate:"Byeongguk Oh",school:"고려대학교 · 경영학과",rows:[["역할","운영 · 재무 총괄"],["경력","KUSMO 재무국장"],["담당","매칭 · 정산 · 품질 관리"]],copy:"CEO의 비전을 실제 실행으로 연결합니다. KUSMO 재무국장을 역임하며 운영·재무 경험을 쌓았습니다.",color:"coral"},
    {role:"CTO",name:"신승윤",alternate:"Seungyun Shin",school:"서울대학교 · 컴퓨터공학부",rows:[["역할","제품 · 기술 총괄"],["경력","KUSMO 회장"],["담당","앱 · 서버 · AI 시스템"]],copy:"앱과 웹, 서버, AI, 시스템 아키텍처까지 서비스의 모든 기술 개발을 책임집니다. KUSMO 회장을 역임했습니다.",color:"violet"},
  ],
  en:[
    ...
    {role:"COO",name:"Byeongguk Oh",alternate:"오병국",school:"Korea University · Business Administration",rows:[["ROLE","Operations · finance"],["EXPERIENCE","Finance Director, KUSMO"],["FOCUS","Matching · billing · quality"]],copy:"Byeongguk turns the company vision into daily execution. He developed his operating and finance experience as Finance Director of KUSMO.",color:"coral"},
    {role:"CTO",name:"Seungyun Shin",alternate:"신승윤",school:"Seoul National University · Computer Science",rows:[["ROLE","Product · technology"],["EXPERIENCE","President, KUSMO"],["FOCUS","Apps · servers · AI systems"]],copy:"Seungyun leads every technical layer of the service, from web and apps to servers, AI, and system architecture. He previously served as President of KUSMO.",color:"violet"},
  ],
};
