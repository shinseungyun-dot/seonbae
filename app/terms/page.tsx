        ...
        <article className={styles.document}>
          ...
          <section id="account">
            ...
            <p>
              ...
              안 됩니다. 이메일 인증을 마쳐야 계정을 정상적으로 사용할 수 있습니다.
          ...
          <section id="availability">
            ...
            <p>
              ...
              알립니다. 이용자는 언제든 계정 삭제를 요청할 수 있으며, 선배는 법령상
              보존할 정보 외의 개인정보를 처리방침에 따라 파기합니다.
            </p>
          </section>
...
function LegalHeader() {
  return (
    <header className={styles.header}>
      ...
      <nav><Link href="/privacy">개인정보 처리방침</Link><Link href="/#/ko/home">홈으로 ↗</Link></nav>
    </header>
  );
}
